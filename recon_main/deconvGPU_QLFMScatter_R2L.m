function XguessOri = deconvGPU_QLFMScatter_R2L(maxIter,Xguess,blur_image,psf,index_1,index_2,alpha,zupdate,Vthres,UPweight)
% Deconvolution with QLFM model considering about backward scattering
% Input:
